...
As priorities are determined by members, working groups will be established. Focus areas include Android, Confidential Compute, Edge Platforms, Linux Fundamentals, Virtualization and Windows on Arm. They aim to deliver standardized tooling and integration workstreams that strengthen the software ecosystem.
